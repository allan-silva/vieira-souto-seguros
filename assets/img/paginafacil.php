...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Vieira Souto Corretora de Seguros</title>
...
<body>
<h1 class="cm-not-in-page">Vieira Souto Corretora de Seguros</h1>
<main>
  <div class="lyt-final-website">
    <div class="img-wrap" style="background: url(Veiculos.jpg) no-repeat 0 0 transparent;">
      <img src="Veiculos.jpg"  alt="">
    </div>
    <div id="site_main_content" class="mod-card">

      <div class="card-wrap">
        <div class="card-img active">
          <img src="" style="display: unset;" alt="">
        </div>
        <div class="card-desc">
          <h4 class="card-title">Vieira Souto Corretora de Seguros</h4>
          <p class="desc"></p>
          <div class="contact-info active">
            <span class="contact-details">15-991893336</span>
            <span class="contact-details">contato@vieirasoutoseguros.com.br</span>
...
try {
  ...
  $inputs = filter_input_array(INPUT_POST, $validateRules);

  if(isset($inputs['email'])) {
    $email_to = "";
    $email_subject = "Contato realizado pelo página fácil Vieira Souto Corretora de Seguros";

    $name = $inputs['name']; // required
    $email_from = $inputs['email']; // required
    $phone = $inputs['phone']; // not required
    $message = $inputs['message']; // required
    ...
    if(strlen($error_message) <= 0) {
      $email_message = "Um novo contato foi realizado através do página fácil Vieira Souto Corretora de Seguros:\n\n";
    ...
    if (false) {
      ...
      $rdstation = new RD_Station($inputs);
  ...
  error_log("EXCEPTION in sending email in pre-site 'Vieira Souto Corretora de Seguros': ". $e->getMessage());
}
?>
